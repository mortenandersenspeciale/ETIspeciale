...
eststo: ivreg2 diffarb3 sp10plogarb1 sp10plogarb2 sp10plogarb3 sp10plogarb4 sp10plogarb5 sp10plogarb6 sp10plogarb7 sp10plogarb8 sp10plogarb9 sp10plogarb10 dlogarb exp exp2 born alder /*
				...
				*/ind7 ind8 ind9 d84 d85 d86 d87 d88 d89 d90 d91 d92 d93 d94 d95 d96 d97 d98 d99 d00 d01 d02 d03 d04 d05 d06 d07 d08 d09 d10 d11 d12 d13 (diffmtr_arb_h3=diffmtr_arb_h_iv3) [aw=arb] if andel0<=0.5 & andel3<=0.5 & arb>=`i'/*
				*/, cluster(id_nr) 	
estadd local loop "min I `i'"
local i = `i'+ 100000
}
			

esttab using loopindkomstminp2.text, replace fragment booktabs keep(diffmtr_arb_h3) label ///
