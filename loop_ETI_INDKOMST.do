...
eststo: ivreg2 diffarb3 sp10plogarb1 sp10plogarb2 sp10plogarb3 sp10plogarb4 sp10plogarb5 sp10plogarb6 sp10plogarb7 sp10plogarb8 sp10plogarb9 sp10plogarb10 dlogarb exp exp2 born alder /*
				...
				*/ind7 ind8 ind9 d84 d85 d86 d87 d88 d89 d90 d91 d92 d93 d94 d95 d96 d97 d98 d99 d00 d01 d02 d03 d04 d05 d06 d07 d08 d09 d10 d11 d12 d13 (diffmtr_arb_h3=diffmtr_arb_h_iv3) [aw=arb] if andel0<=0.5 & andel3<=0.5 & dummyarb==20/*
				*/, cluster(id_nr) 	
*/
...
eststo: ivreg2 diffarb3 sp10plogarb1 sp10plogarb2 sp10plogarb3 sp10plogarb4 sp10plogarb5 sp10plogarb6 sp10plogarb7 sp10plogarb8 sp10plogarb9 sp10plogarb10 dlogarb exp exp2 born alder /*
				*/ gift unem gdp mand udd1 udd2 udd3 udd4 udd5 udd0 amt1 amt2 amt3 amt4 amt5 amt6 amt7 amt8 amt9 amt10 amt11 amt12 amt13 amt14 amt15 ind1 ind2 ind3 ind4 ind5 ind6 /*
				*/ind7 ind8 ind9 d84 d85 d86 d87 d88 d89 d90 d91 d92 d93 d94 d95 d96 d97 d98 d99 d00 d01 d02 d03 d04 d05 d06 d07 d08 d09 d10 d11 d12 d13 (diffmtr_arb_h3=diffmtr_arb_h_iv3) [aw=arb] if andel0<=0.5 & andel3<=0.5 & dummyarb<=`i'+5 & dummyarb>=`i'/*
				*/, cluster(id_nr) 	
estadd local loop "gruppe `i' indkomst"
local i = `i'+ 2
}
			

esttab using indkomstloop5grupperp2.text, replace fragment booktabs keep(diffmtr_arb_h3) label ///
...
eststo: ivreg2 diffarb3 sp10plogarb1 sp10plogarb2 sp10plogarb3 sp10plogarb4 sp10plogarb5 sp10plogarb6 sp10plogarb7 sp10plogarb8 sp10plogarb9 sp10plogarb10 dlogarb exp exp2 born alder /*
				*/ gift unem gdp mand udd1 udd2 udd3 udd4 udd5 udd0 amt1 amt2 amt3 amt4 amt5 amt6 amt7 amt8 amt9 amt10 amt11 amt12 amt13 amt14 amt15 ind1 ind2 ind3 ind4 ind5 ind6 /*
				*/ind7 ind8 ind9 d84 d85 d86 d87 d88 d89 d90 d91 d92 d93 d94 d95 d96 d97 d98 d99 d00 d01 d02 d03 d04 d05 d06 d07 d08 d09 d10 d11 d12 d13 (diffmtr_arb_h3=diffmtr_arb_h_iv3) [aw=arb] if andel0<=0.5 & andel3<=0.5 & dummyarb<=`i'+10 & dummyarb>=`i'/*
				*/, cluster(id_nr) 	
estadd local loop "gruppe `i' indkomst"
local i = `i'+ 2
}
...
esttab using indkomstloop10grupper.text, replace fragment booktabs keep(diffmtr_arb_h3) label ///
mgroups("Lønmodtagere", pattern(1 0 0 0 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) ///
star(* .1 ** .05 *** .01) brackets se nomtitles stats(loop N, label("max I" "Obs."))
